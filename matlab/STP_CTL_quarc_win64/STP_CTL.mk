...
MODEL                = STP_CTL
MODULES              = STP_CTL_data.c STP_CTL_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_sim.c
MAKEFILE             = STP_CTL.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\code\Direct-Drive-Haptic-Actuator\matlab
...
MODELLIB                  = STP_CTLlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = STP_CTL_ref.rsp

COMPILER_COMMAND_FILE     = STP_CTL_comp.rsp
