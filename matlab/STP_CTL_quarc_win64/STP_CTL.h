...
#endif                                 /* STP_CTL_COMMON_INCLUDES_ */

#include "STP_CTL_types.h"
...
#define STP_CTL_rtModel                RT_MODEL_STP_CTL_T

/* Block signals (default storage) */
typedef struct {
  real_T F1;                           /* '<Root>/Read F//T Nano25' */
  real_T T1;                           /* '<Root>/Read F//T Nano25' */
  real_T F2;                           /* '<Root>/Read F//T Nano25' */
  real_T T2;                           /* '<Root>/Read F//T Nano25' */
  real_T F3;                           /* '<Root>/Read F//T Nano25' */
  real_T T3;                           /* '<Root>/Read F//T Nano25' */
  real_T frequency;                    /* '<Root>/MATLAB Function' */
} B_STP_CTL_T;
...
#define rtB                            STP_CTL_B
#define BlockIO                        B_STP_CTL_T
#define rtP                            STP_CTL_P
#define Parameters                     P_STP_CTL_T
#define rtDWork                        STP_CTL_DW
#define D_Work                         DW_STP_CTL_T
...
extern P_STP_CTL_T STP_CTL_P;

/* Block signals (default storage) */
extern B_STP_CTL_T STP_CTL_B;
 ...
 * External functions *
 *====================*/
extern STP_CTL_rtModel *STP_CTL(void);
...
extern RT_MODEL_STP_CTL_T *const STP_CTL_M;
